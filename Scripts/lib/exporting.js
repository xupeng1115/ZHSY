		...
		r(B.prototype, {
			...
			contextMenu: function(a, b, e, c, v, m, g) {
				...
				l || (d[n] = l = p("div", {
						...
						if(f.isObject(a, !0)) {
							var b;
							a.separator ? b = p("p", null, null, y) : (b = p("div", {
			...
			addButton: function(a) {
				...
				if(!1 !== c.enabled) {
					...
					c.text && c.symbol ? h.paddingLeft = D(h.paddingLeft, 25) : c.text || r(h, {
						width: c.width,
						height: c.height,
						padding: 0
					});
					...
					c.symbol &&
						(g = e.symbol(c.symbol, c.symbolX - k / 2, c.symbolY - k / 2, k, k).addClass("highcharts-button-symbol").attr({
							zIndex: 1
						}).add(d), g.attr({
